...
public:
	...
	void encrypt(const string& plain_txt, const string& key)
	{
		...
		cout << "Initial LPT :" << Bin_to_Hex(L) << "\n";

		for (int i = 32; i < 64; i++)
			R += IP[i];

		cout << "Initial RPT :" << Bin_to_Hex(R) << "\n\n";
		...
		cout << "After expansion permutation in round "<< 1 << ": " << Bin_to_Hex(R_48[0]) << "\n";
		cout << "Key used in the round "<< 1 <<":" << Bin_to_Hex(key_48[0]) << "\n";
		...
		cout << "LPT After round " << 1 << " is " << Bin_to_Hex(L_32[0]) << "\n";
		cout << "RPT After round " << 1 << " is " << Bin_to_Hex(R_32[0]) << "\n";
		cout << "\n\n";
...

		{
			...
			cout << "After expansion permutation in round " <<  i + 1 << ":" << Bin_to_Hex(R_48[i]) << "\n";
			cout << "Key used in the round " << i + 1 << ":" << Bin_to_Hex(key_48[i]) << "\n";
			...
			cout << "LPT After round " << i+1 << " is " <<  Bin_to_Hex(L_32[i]) << "\n";
			//cout << "Binary LPT After round " << i+1 << " is " << L_32[i] << "\n";
			cout << "RPT After round " << i+1 << " is " <<  Bin_to_Hex(R_32[i]) << "\n";
			//cout << "Binary RPT After round " << i+1 << " is " <<  R_32[i] << "\n";
			cout << "\n\n";
		}
		...
		cout << "\nFinal encrypted value :" << Bin_to_Hex(encrypted_bin) << endl;
